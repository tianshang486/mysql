...
-   流量费用：详见[数据库备份DBS产品价格](https://www.alibabacloud.com/zh/products/database-backup)。
...
2.  在页面左上角，选择实例所在地域。
    ...
    ![选择地域](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/328067/156267192748250_zh-CN.png)
...
4.  设置如下参数：
 ...
 |
    ...
    ![跨地域备份设置](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/328067/156267192848555_zh-CN.png)
...
3.  找到目标实例，单击最右侧的**编辑**，就可以修改跨地域备份设置。
    ...
    **说明：** 如果实例已被释放，则只能修改保留天数，其它选项无法修改。
    ...
    ![跨地域备份列表](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/328067/156267192848556_zh-CN.png)
