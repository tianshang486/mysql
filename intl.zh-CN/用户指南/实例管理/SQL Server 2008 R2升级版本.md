...
-   SQL Server 2008 R2实例不能开启[SSL](../intl.zh-CN/用户指南/数据安全性/设置 SSL 加密.md#)和[TDE](../intl.zh-CN/用户指南/数据安全性/设置透明数据加密.md#)功能。
...
2.  选择实例所在地域。
    ...
    ![选择地域](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7814/155313179136543_zh-CN.png)

3.  单击实例的ID。
4.  在基本信息页面，单击**升级版本**，在弹出的对话框中单击**确定**。

    ![升级数据库版本](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/142817/155313179141115_zh-CN.png)
...
|
 ...
 |
    ...
    ![升级配置](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/142817/155313179141116_zh-CN.png)
