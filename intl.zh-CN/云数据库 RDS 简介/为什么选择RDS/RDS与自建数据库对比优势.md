...
-   若在不同地域，ECS实例之间可以通过外网互通，需收取外网流量费用，详细收费标准请参见[公网带宽计费](/intl.zh-CN/产品定价/计费项/公网带宽计费.md)。
...
-   最多2倍存储空间大小的[免费备份空间](/intl.zh-CN/RDS MySQL 数据库/备份/查看备份空间免费额度.md)。
-   公网流量免费。
-   免费使用自带的域名。
-   更新速度快，紧跟MySQL最新版本。
...
-   最多2倍存储空间大小的[免费备份空间](/intl.zh-CN/RDS PostgreSQL 数据库/备份/查看备份空间免费额度.md)。
-   公网流量免费。
-   免费使用自带的域名。
...
-   [自动化监控告警](/intl.zh-CN/RDS PostgreSQL 数据库/监控与报警/设置报警规则.md)系统，覆盖实例和数据库所有性能指标，支持短信、邮箱、旺旺、钉钉等通道，且根据消费有大额度的免费短信数量。
