 ...
 **说明：** 不同地域支持的数据库类型不同，请以实际界面为准。
 ...
 |
    |版本|指PostgreSQL的版本。RDS for PostgreSQL支持的版本包括PostgreSQL 9.4、PostgreSQL 10。**说明：** 不同地域所支持的版本不同，请以实际界面为准。
...
![选择地域](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7814/155168482036543_zh-CN.png)
