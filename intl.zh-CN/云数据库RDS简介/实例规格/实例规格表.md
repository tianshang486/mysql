...
本文介绍RDS的实例规格，帮助您了解RDS实例的最新规格信息和历史规格信息。

## RDS for MySQL {#section_f33_wwz_xdb .section}

|系列|版本|规格族|规格代码|CPU和内存|最大连接数|最大IOPS|存储空间|
|--|--|---|----|------|-----|------|----|
|基础版|5.7/8.0|通用型|mysql.n1.micro.1|1核 1GB|2000|min\{30 x 存储空间, 20000\}|20GB-6000GB|
...
|mysql.x8.8xlarge.2|64核 512GB|-|-|3000GB/4000GB/5000GB/6000GB|
...
|独占物理机|rds.mysql.st.v52|960核 720GB|-|-|3000GB/4000GB/5000GB/6000GB|
