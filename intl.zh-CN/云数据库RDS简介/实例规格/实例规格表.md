...
|--|--|---|----|------|-----|------|----|
|基础版|5.7/8.0|通用型|mysql.n1.micro.1|1核 1GB|2000|min\{30 x 存储空间, 20000\}|20GB-1000GB|
...
|独占物理机|rds.mysql.st.h43|60核 470GB|100000|50000|3000GB/4000GB/5000GB/6000GB|
...
## RDS for SQL Server主实例 {#section_hdl_77q_4fm .section}
...
|系列|版本|规格族|规格代码|CPU和内存|最大连接数|最大IOPS|存储空间|
|--|--|---|----|------|-----|------|----|
|集群版|2017企业版|通用型|rds.mssql.s2.large|2核 4GB|无限制|取决于SSD云盘性能|20GB-4000GB|
|rds.mssql.s3.large|4核 8GB|
|rds.mssql.c1.large|8核 16GB|
|rds.mssql.s2.xlarge|2核 8GB|
|rds.mssql.m1.medium|4核 16GB|
...
## RDS for PostgreSQL {#section_h30_vdx_meo .section}
...
## 历史规格 RDS for PostgreSQL {#section_0n8_r0b_8s7 .section}
