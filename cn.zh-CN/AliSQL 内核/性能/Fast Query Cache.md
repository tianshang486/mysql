...
Fast Query Cache需要配置一定量的内存才能起到良好的效果，可能需要降低InnoDB Buffer Pool的内存空间，将更多内存空间提供给Query Cache。Fast Query Cache目前处于邀请测试阶段，您如果感兴趣，可以[提交工单](https://selfservice.console.aliyun.com/ticket/createIndex)申请开通此功能。
