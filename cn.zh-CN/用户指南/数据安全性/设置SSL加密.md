...
-   支持SSL加密的实例版本如下：
    -   SQL Server所有版本
    -   MySQL 5.6金融版、MySQL 5.6高可用版、MySQL 5.7高可用本地盘版、MySQL 8.0高可用本地盘版
...
2.  在页面左上角，选择实例所在地域。
    ...
    ![地域截图](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7882/155857488337169_zh-CN.png)
...
6.  单击**未开通**前面的开关，如下图所示。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7949/15585748834147_zh-CN.png)

7.  在设置 SSL对话框中选择要开通SSL加密的链路，单击**确定**，开通 SSL 加密。

    **说明：** 用户可以根据需要，选择加密内网链路或者外网链路，但只可以加密一条链路。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7949/15585748834148_zh-CN.png)

8.  单击**下载证书**，下载SSL CA证书，如下图所示。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7949/15585748834149_zh-CN.png)
...
4.  在**SSL CA File**栏单击...选择PEM文件。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7949/15585748834150_zh-CN.png)
...
![更新证书有效期](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7949/155857488345367_zh-CN.png)
