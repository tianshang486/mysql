...
7.  选择迁移对象及迁移类型。
    ...
    ![选择迁移类型和迁移对象](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/zh-CN/2767559951/p47745.png)
...
-   Q：预检查失败如何处理？
    ...
    A：详情请参见[源库连接性检查](/cn.zh-CN/数据迁移/预检查及修复方法/DTS预检查阶段对源数据库进行连接性检查.md)。

-   Q：迁移失败的任务如何处理？

    A：详情请参见[修复迁移失败的任务](/cn.zh-CN/数据迁移/迁移任务管理/修复迁移失败的任务.md)。
