...
## RDS for MySQL 5.5/5.6/5.7/8.0 主实例（本地盘） {#section_sfd_zpr_rlv .section}
...
|2012企业版、2016企业版|独享型|mssql.x4.medium.e2|2核8GB|无限制|取决于云盘性能|20GB-4000GB|
...
## RDS for PostgreSQL {#section_xe8_op0_gyq .section}
