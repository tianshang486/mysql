...
![ping测试](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/41754/155479382038361_zh-CN.png)

![telnet测试](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/41754/155479382038362_zh-CN.png)
...
2.  在配置文件末尾加入如下配置。
    ...
    **说明：** 如果已经有DNS1和DNS2配置，请将IP地址修改为如上所示。
    ...
    ![修改dns](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/41754/155479382038364_zh-CN.png)
...
4.  使用如下命令查看是否修改成功。
    ...
    ![修改dns成功](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/41754/155479382038363_zh-CN.png)


## 连接数已满 {#section_wyr_jdc_5gb .section}

连接数满通常是由于空闲连接过多或活动连接过多，具体原因及解决办法请参见[RDS for MySQL 连接数满情况的处理](cn.zh-CN/常见问题/网络__IP/RDS for MySQL 连接数满情况的处理.md#)或[RDS for PostgreSQL 连接数满情况的处理](cn.zh-CN/常见问题/网络__IP/RDS for PostgreSQL 连接数满情况的处理.md#)。
