...
![ping测试](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/41754/156395461638361_zh-CN.png)

![telnet测试](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/41754/156395461638362_zh-CN.png)
...
2.  在配置文件末尾加入如下配置。
    ...
    **说明：** 如果已经有DNS1和DNS2配置，请将IP地址修改为如上所示。
    ...
    ![修改dns](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/41754/156395461638364_zh-CN.png)
...
4.  使用如下命令查看是否修改成功。
    ...
    ![修改dns成功](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/41754/156395461638363_zh-CN.png)
