...
完成[创建实例](intl.zh-CN/RDS for MySQL 快速入门/创建RDS for MySQL实例.md)、[设置白名单](intl.zh-CN/RDS for MySQL 快速入门/初始化配置/设置白名单.md#)和[创建账号](intl.zh-CN/RDS for MySQL 快速入门/初始化配置/创建账号和数据库.md)等操作后，您可以使用通用数据库客户端连接到RDS实例，也可以在应用程序中配置地址、端口、账号信息等进行连接。
...
2.  在连接管理对话框中，单击**新建**。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7823/15529018872607_zh-CN.png)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7823/15529018872609_zh-CN.png)
...
4.  在连接管理对话框中，选中刚才创建的连接，单击**打开**。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7823/15529018872610_zh-CN.png)
