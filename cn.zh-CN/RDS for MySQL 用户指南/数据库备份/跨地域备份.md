...
2.  在页面左上角，选择实例所在地域。
    ...
    ![选择地域](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/328067/156799172748250_zh-CN.png)
...
4.  设置如下参数：
 ...
 |
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/328067/156799172751473_zh-CN.png)
...
通过DLA可以实现即时查询异地备份数据，操作步骤请参见[数据库异地备份及查询最佳实践](../../../../cn.zh-CN/最佳实践/MySQL/场景应用/数据库异地备份及查询最佳实践.md#)。
