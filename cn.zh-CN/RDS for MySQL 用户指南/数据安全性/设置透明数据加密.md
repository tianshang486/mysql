...
2.  在页面左上角，选择实例所在地域。
    ...
    ![选择地域](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7814/155901015936543_zh-CN.png)
...
5.  在TDE页签单击**未开通**左边的滑块。
    ...
    **说明：** 仅特定实例支持TDE功能，请参见[前提条件](#)。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7950/15590101594151_zh-CN.png)
