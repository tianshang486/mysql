...
2.  在页面左上角，选择实例所在地域。
    ...
    ![选择地域](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7814/156655416836543_zh-CN.png)
...
6.  单击**未开通**前面的开关，如下图所示。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7949/15665541694147_zh-CN.png)

7.  在设置 SSL对话框中选择要开通SSL加密的链路，单击**确定**，开通 SSL 加密。

    **说明：** 用户可以根据需要，选择加密内网链路或者外网链路，但只可以加密一条链路。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7949/15665541694148_zh-CN.png)

8.  单击**下载证书**，下载SSL CA证书，如下图所示。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7949/15665541694149_zh-CN.png)
...
3.  启用**Use SSL**，并导入SSL CA证书，如下图所示。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7949/15665541694150_zh-CN.png)
...
2.  在目标数据库上单击鼠标右键，选择**编辑连接** 。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/41826/156655416952885_zh-CN.png)

3.  选择SSL页签，选择.pem格式CA证书的路径。参照下图进行设置。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/41826/156655416952887_zh-CN.png)
...
5.  双击目标数据库测试能否正常连接。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/41826/156655417052889_zh-CN.png)
...
![更新证书有效期](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7949/156655417045367_zh-CN.png)
...
6.  单击**已开通**前面的开关，在弹出的提示框中单击**确定**。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/41826/156655417057405_zh-CN.png)
