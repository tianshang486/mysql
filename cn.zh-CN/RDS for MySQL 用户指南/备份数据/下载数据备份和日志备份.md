...
2.  选择目标实例所在地域。
    ...
    ![选择地域](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7814/154907028836543_zh-CN.png)
...
8.  在实例备份文件下载确认或Binlog文件下载框中，选择下载方式。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7966/15490702886231_zh-CN.png)
...
-   日志备份内，同一个Binlog文件名为什么存在两份？
    ...
    答：高可用版实例包括主实例和备实例，主备实例都会生成Binlog文件，通过**BINLOG所在实例编号**进行区分。可以在服务可用性页面查看主备实例的编号。

    ![实例编号](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/67074/154907028838570_zh-CN.png)
