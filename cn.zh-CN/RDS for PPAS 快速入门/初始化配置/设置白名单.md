...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7816/156350334735435_zh-CN.png)

![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7816/156350334735436_zh-CN.png)
...
2.  在页面左上角，选择实例所在地域。
    ...
    ![选择地域](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7814/156350334736543_zh-CN.png)
...
5.  在白名单设置页面中，根据以下连接类型进行后续操作。
    ...
    **说明：** 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7816/156350334735445_zh-CN.png)
...
6.  在弹出的对话框中，填写需要访问该实例的IP地址或IP段，然后单击**确定**。
    ...
    **说明：** 当您在**default**分组中添加新的IP地址或IP段后，默认地址127.0.0.1会被自动删除。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7816/15635033481795_zh-CN.png)
...
5.  在白名单设置页面中，单击**default**白名单分组中的**修改**，如下图所示。
    ...
    **说明：** 您也可以单击**添加白名单分组**新建自定义分组。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/7816/15635033481794_zh-CN.png)
...
-   您在白名单中添加的设备公网IP地址可能并非设备真正的出口IP地址。原因如下：
    ...
    解决办法请参见[RDS for PostgreSQL/PPAS 如何定位本地 IP](../intl.zh-CN/常见问题/如何连接__无法连接/RDS for PostgreSQL__PPAS 如何定位本地 IP.md#)。
