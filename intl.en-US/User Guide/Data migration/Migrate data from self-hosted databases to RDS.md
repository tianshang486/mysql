# Migrate data from self-hosted databases to RDS {#concept_vxv_pq5_ydb .concept}

You can import data from self-hosted databases to ApsaraDB RDS. Choose a method based on the specific scenario.

## Migrate from ECS-hosted databases to RDS {#section_ysw_rq5_ydb .section}

[Migrate databases from ECS to RDS, MongoDB, Redis, DRDS, HybridDB, or OceanBase](https://www.alibabacloud.com/help/doc-detail/26627.htm)
...
[Migrate data from on-premises Oracle to RDS for PPAS without stopping services](https://www.alibabacloud.com/help/zh/doc-detail/26623.htm)
