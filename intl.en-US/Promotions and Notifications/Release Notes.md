...
|SQL Server|SQL Server 2016 EE Basic|SQL Server 2016 EE Basic is supported forRDS instances in the dedicated instance family.|2019-07-25|[Create an ApsaraDB RDS for SQL Server instance](/intl.en-US/RDS SQL Server Database/Quick start/Create an ApsaraDB RDS for SQL Server instance.md)|
