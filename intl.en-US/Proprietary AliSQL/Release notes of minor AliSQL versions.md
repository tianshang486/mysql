...
-   New features:
    -   The Binlog in Redo feature is introduced. This feature writes binary logs into redo log files before the binary logs are written to the disk. This reduces I/O consumption and improves database performance. For more information, see [Binlog in Redo](/intl.en-US/Proprietary AliSQL/Performance/Binlog in Redo.md).
...
-   New features:
    ...
    -   The returning feature is introduced. This feature allows data manipulation language \(DML\) statements to return result sets. In addition, the DBMS\_TRANS package is provided for you to use this feature. For more information, see [Returning](/intl.en-US/Proprietary AliSQL/Feature/Returning.md).
